...
// 005 T010: 9 findings-display cases moved out of the departing layout test
// file (triage-record.md rows 11, 12, 20, 28, 43-47), each mounting
// AnalysisOutput alone instead of the departing page.
