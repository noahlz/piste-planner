...
- [X] T006 Dispatch `test-quality-reviewer` covering the tests added in T002 and T004, apply accepted findings, and re-run the two test files. Commit if anything changed.
