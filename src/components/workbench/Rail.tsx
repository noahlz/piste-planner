...
/**
 * The left rail: four collapsible panels over existing section components,
 * mounted unmodified (FR-004, S2-contract.md §Rail panels), plus the Advanced
 * panel. Scrolls independently of the center.
 *
 * Pool durations moved out to the gears panel (US5, FR-043,
 * `SettingsPanel.tsx`) and is no longer one of these.
 *
