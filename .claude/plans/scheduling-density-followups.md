...
### Cheap / low-risk
1. **Consider tuning `SABER_PILEUP_PENALTY_TABLE`.** B4 regressed 9 → 6 after refs-as-output landed because the saber pileup penalty is punishingly high (50.0 for 4+ on one day). B4 has 10 saber events / 3 days, so by pigeonhole at least one day hits 4+ regardless. Try halving the table and measure; if B4 recovers without introducing regressions elsewhere, keep.
